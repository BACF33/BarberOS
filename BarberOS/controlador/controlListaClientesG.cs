...
namespace BarberOS.Controlador
{
    internal class ControlListaClientesG
    {
        ...
        public ControlListaClientesG(VistaListaClientesG vistaPasada, vistaMenu passedMenuForm)
        {
            ...
            controladaVista.btnACortes.Click += (sender, e) => passedMenuForm.controladorMenu.AbrirFormulario(new VistaListaPromocionesG(passedMenuForm));
        ...
        public void ShowData()
        {
            if (controladaVista.listClientes.SelectedItems.Count > 0)
            {
                ...
                controladaVista.txtEmail.Text = seleccionado.SubItems[4].Text;
            }
            else
            {
